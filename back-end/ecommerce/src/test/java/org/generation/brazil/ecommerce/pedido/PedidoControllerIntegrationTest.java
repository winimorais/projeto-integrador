...
public class PedidoControllerIntegrationTest {
    ...
    public void save() {
        ...
        HttpEntity<Pedido> entity = new HttpEntity<>(PedidoMock.getPedidoMock(), headers);

        ResponseEntity<Pedido> responseEntity = testRestTemplate.exchange(
                getRootUrl("/pedidos/"),
                HttpMethod.POST,
                entity,
                Pedido.class
    ...
    public void findById() {
        ...
        ResponseEntity<Pedido> response = testRestTemplate.exchange(
                getRootUrl("/pedidos/1"),
                HttpMethod.GET,
                entity,
                Pedido.class);
    ...
    public void delete() {
        ...
        try {
            testRestTemplate.getForObject(getRootUrl("/pedidos/delete/" + id), Pedido.class);
